...
class DataAsinSpider(scrapy.Spider):
    ...
    start_urls = ("https://www.amazon.com/s/ref=sr_pg_2?fst=as%3Aoff&rh=n%3A16225018011%2Cn%3A1040660%2Cn%3A1258603011&page={}&bbn=16225018011&ie=UTF8&qid=1545919425&ajr=3".format(i) for i in range(1,4))
